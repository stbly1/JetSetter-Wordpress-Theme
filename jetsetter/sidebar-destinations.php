...
<div id='secondary'>
	...
	<div id="content-sidebar" class="content-sidebar widget-area" role="complementary">
		...
		<div class='category-navigation'>
			...
			<?php
				$galleryName = get_post_meta($post->ID, 'Gallery',true);
				$args = array(
					'post_type' => 'galleries',
					'orderby' => 'date',
				    'order' => 'DESC',
				...
				foreach($galleryPosts as $post) :
					setup_postdata($post); 
					$currentTitle = the_title('','',false);
					if($currentTitle == $galleryName){
						$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' );
						?>
						<div class='container'>
							<a id='gallery-link' href='<?php the_permalink()?>' style='background-image:inherit'>
								<span style='text-decoration:none;' class='region-title'>View the Gallery</span>
							</a>
						</div>
						<?php	
					}
